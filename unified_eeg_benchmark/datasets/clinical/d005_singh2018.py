...
def _load_data_singh2018(subjects: Sequence[int], target_class: ClinicalClasses):
...
class ParkinsonsConflictTaskD005Dataset(BaseClinicalDataset):
    def __init__(
        self,
        ...
        # fmt: on
        logging.info("in ParkinsonsConflictTaskD005Dataset.__init__")
        self.meta = {
    ...
    def load_data(self) -> None:
        ...
        self.data, self.labels = self.cache.cache(_load_data_singh2018)(self.subjects, self.target_classes[0]) # type: ignore