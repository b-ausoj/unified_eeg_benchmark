...
def _load_data_singh2021(subjects: Sequence[int], target_class: ClinicalClasses):
...
class PDIntervalTimingD014Dataset(BaseClinicalDataset):
    ...
    def load_data(self) -> None:
        ...
        self.data, self.labels = self.cache.cache(_load_data_singh2021)(self.subjects, self.target_classes[0]) # type: ignore
