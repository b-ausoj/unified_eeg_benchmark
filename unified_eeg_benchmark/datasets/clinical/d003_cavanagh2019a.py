...
def _load_data_cavanagh2019a(subjects: Sequence[int], target_class: ClinicalClasses, sampling_frequency: int, resampling_frequency: Optional[int] = None) -> Tuple[Sequence[np.ndarray], np.ndarray]:
...
class DepressionRestD003Dataset(BaseClinicalDataset):
    ...
    def load_data(self) -> None:
        ...
        self.data, self.labels = self.cache.cache(_load_data_cavanagh2019a)(self.subjects, self.target_classes[0], self._sampling_frequency, self._target_frequency) # type: ignore
