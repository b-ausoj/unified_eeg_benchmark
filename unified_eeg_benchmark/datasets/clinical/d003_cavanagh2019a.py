...
DATA_PATH = get_config_value("d003")


def _load_data_cavanagh2019a(subjects: Sequence[int], split: Split, target_class: ClinicalClasses, sampling_frequency: int, resampling_frequency: Optional[int] = None) -> Tuple[Sequence[np.ndarray], np.ndarray]:
    ...
    dep_ids = ["558", "559", "561", "564", "565", "566", "567", "569", "586", "587", "590", "591", "592", "594", "595", "597", "598", "602", "603", "604", "605", "606", "607", "608", "609", "610", "611", "612", "613", "614", "615", "616", "617", "618", "619", "620", "621", "622", "623", "624", "625", "626", "627", "628"]
    ctr_ids = ["507", "508", "509", "510", "511", "512", "513", "514", "515", "516", "517", "518", "519", "520", "521", "522", "523", "524", "525", "526", "527", "528", "529", "530", "531", "532", "533", "534", "535", "536", "537", "538", "539", "540", "541", "542", "543", "545", "546", "547", "548", "549", "550", "551", "552", "553", "554", "555", "556", "557", "560", "562", "563", "568", "570", "573", "574", "575", "576", "577", "578", "579", "580", "581", "582", "583", "584", "585", "588", "589", "593", "596", "599", "600", "601"]
    ...
    data = []
    labels = []
    for subject in tqdm(subjects, desc="Loading data from Cavanagh2019a"):
        file_path = f"{DATA_PATH}Matlab Files/{subject}_Depression_REST.mat"
...
class DepressionRestD003Dataset(BaseClinicalDataset):
    ...
    def load_data(self, split) -> None:
        ...
        self.data, self.labels = self.cache.cache(_load_data_cavanagh2019a)(self.subjects, split, self.target_classes[0], self._sampling_frequency, self._target_frequency) # type: ignore
        ...
        plt.grid(True)
        plt.savefig('eeg_signal_distribution_d003.png')
        plt.close()
        """
